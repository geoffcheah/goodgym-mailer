...
john = Runner.create!(email: "jd@gmail.com", first_name: "John", last_name: "Doe", status: "never_run", area: westminster)
henry = Runner.create!(email: "hc@gmail.com", first_name: "Henry", last_name: "Cavill", status: "lapsed", area: westminster)
arnold = Runner.create!(email: "as@gmail.com", first_name: "Arnold", last_name: "Schwarzenegger", status: "regular", area: westminster)
ellen = Runner.create!(email: "ed@gmail.com", first_name: "Ellen", last_name: "Degenneres", status: "never_run", area: westminster)
theresa = Runner.create!(email: "tm@gmail.com", first_name: "Theresa", last_name: "May", status: "lapsed", area: westminster)
